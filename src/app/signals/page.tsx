      ...
      <div className="min-w-0">
        ...
        {signal.sourceUrl ? (
          <a
            ...
            className="mt-2 block text-2xl font-semibold tracking-[-0.02em] text-balance transition-opacity hover:opacity-70"
          >
            {signal.title}
          </a>
        ) : (
      ...
      <div className="mx-auto max-w-5xl px-6 pb-24 pt-10">
        ...
        <header className="mb-12 border-t border-black/10 pt-6 dark:border-white/10">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 opacity-70">
            A running file of the business moves, margin clues, platform tells,
            and executive admissions worth tracking.
          </p>
        </header>
